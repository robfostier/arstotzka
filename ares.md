...
tech@ares:~$ sudo iptables -A FORWARD -i ens37 -o ens33 -j ACCEPT
tech@ares:~$ sudo iptables -A FORWARD -i ens33 -o ens37 -m state --state ESTABLISHED,RELATED -j ACCEPT
